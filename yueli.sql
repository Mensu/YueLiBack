...
CREATE TABLE IF NOT EXISTS `yueli`.`notification` (
  ...
  `type` ENUM('like-comment', 'comment-comment', 'comment-travel', 'comment-feeling', 'follow-user', 'post-travel', 'update-travel', 'post-feeling') NOT NULL COMMENT '消息类型',
